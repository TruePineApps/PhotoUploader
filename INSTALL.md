...
PhotoUploader Beta is a native desktop application for Windows, macOS, and Linux. This guide covers the 
...
> PhotoUploader Beta comes with its own optimized, private Java runtime bundled inside the installer.

### Windows (.msi)
1.  Download the `PhotoUploader Beta-1.0.65535.msi` installer.
2.  Double-click the file to launch the setup wizard.
3.  Follow the on-screen instructions.
4.  Launch the app from the Start Menu or Desktop shortcut.

### macOS (.dmg)
1.  Download the `PhotoUploader Beta-1.0.65535.dmg` disk image.
2.  Open the `.dmg` file.
3.  Drag the **PhotoUploader** icon into your **Applications** folder.
...
### Linux (.deb)
1.  Download the `PhotoUploader Beta-1.0.65535.deb` package.
