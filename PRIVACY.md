...
("the Developer"), handles personal data within the application **Photo-Uploader** ("the App").
The App is a tool designed to upload photos to Google Photos and organize them into albums based
on local directory structures.

As a developer based in the Netherlands, I am committed to protecting your privacy in accordance
...
- **`photoslibrary.appendonly`** — To upload photos and create albums in your Google Photos
  library.
- **`photoslibrary.readonly.appcreateddata`** — To track albums and photos created by the App,
  in order to prevent duplicate uploads.
...
Google LLC is based in the United States. By using the App, your personal data (email address,
authentication metadata, and photo content) is processed by Google on servers that may be
...
- **Right to Lodge a Complaint:** You have the right to lodge a complaint with the Dutch Data
