...
class NoticesRenderer(private val filename: String = "THIRD-PARTY-NOTICES.txt",
                      private val outputDirectory: File? = null) : ReportRenderer {
    ...
    override fun render(data: ProjectData) {
        ...
        data.allDependencies.forEach { module ->
            ...
            uniqueModules.add("${module.group}:${module.name}:${module.version}")
        }
        ...
        output.bufferedWriter().use { writer ->
            ...
            writer.write("Note: Some packages may be listed under combined license headers (e.g., Apache OR LGPL).\n\n")
